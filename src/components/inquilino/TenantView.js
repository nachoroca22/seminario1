...
// Componentes
import Nav from './Nav'
import LateralNav from './LateralNav.js'
import Property from './Property'
import Footer from '../Footer'

// Importo llamada a endpoint
import {GetPropertyByTenantId as PropertiesTenantAPI} from "../controller/MainController";
...
class Tenant extends Component {
    ...
    getProperty = async () => {
        // Ejecuto el endopoint para trae las propiedades del inquilino
        const userMail = localStorage.getItem('email')
        console.log(userMail)  
        this.setState({loading: true});
        let getPropertyFromAPI = await PropertiesTenantAPI(userMail);
                                    ...
                                    <div className="container">
                                        ...
                                        <div className="row align-items-center justify-content-center mb-5">
                                            ...
                                            <div className="text-center mt-5">
                                                ...
                                                <br/>
                                                <span className="text-secondary">Aun no tienes propiedades cargadas.</span>
                                            </div>
